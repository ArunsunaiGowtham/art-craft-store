...
headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) UrbanSketchCrawler/1.0'}

queries = [
    "sketching city street",
    "plein air painter",
    "watercolour sketch street",
    "sketching architectural",
    "sketchbook drawing street"
]

for q in queries:
    time.sleep(1)
    search_url = f"https://commons.wikimedia.org/w/api.php?action=query&list=search&srsearch={urllib.parse.quote(q)}&srnamespace=6&format=json&srlimit=6"
    try:
