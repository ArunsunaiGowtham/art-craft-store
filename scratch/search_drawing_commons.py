...
queries = {
    'figure_drawing': 'File:Life drawing sketch',
    'perspective': 'File:Architectural perspective drawing',
    'ink_drawing': 'File:Ink drawing pen',
    'sketchbook': 'File:Artist sketchbook pages drawing'
}
