...
titles = [
    "File:Macrame wall hanging.jpg",
    "File:Macrame.jpg",
    "File:Macramé.jpg",
    "File:Embroidery.jpg",
    "File:Hand embroidery.jpg",
    "File:Mosaic workshop.jpg",
    "File:Leather crafting tools.jpg",
    "File:Leathercraft.jpg"
]
        ...
        with urllib.request.urlopen(req, timeout=10) as res:
            ...
            for pid, pdata in pages.items():
                if 'imageinfo' in pdata:
                    ...
                    dest = f"images/crafting_samples/craft_{i+1}.jpg"
