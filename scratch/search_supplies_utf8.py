...
headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) ArtStore/1.0'}
...
queries = {
    'pencils': 'File:Buntstifte',
    'markers': 'File:Felt-tip pens',
    'markers2': 'File:Marker pens',
    'sketching': 'File:Pencil case drawing',
    'art_box': 'File:Pelikan watercolours'
}
