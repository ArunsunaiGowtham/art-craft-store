...
queries = {
    'composition': 'File:Rule of thirds diagram',
    'golden_ratio': 'File:Golden spiral art',
    'color_wheel': 'File:Color wheel color theory',
    'palette': 'File:Artist color palette mixing'
}
