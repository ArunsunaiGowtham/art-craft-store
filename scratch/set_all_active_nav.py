...
for page, (target, sub_target) in page_map.items():
    ...
    if target == 'home':
        ...
        nav_body = re.sub(r'class="dropdown-item active"', r'class="dropdown-item active"', nav_body)
    elif target:
    ...
    print(f"Updated navbar active state in {page} -> target: {target}")

print("\nAll HTML files updated with exact active link highlights!")
