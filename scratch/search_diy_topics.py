...
queries = {
    'handmade_paper': 'File:Making handmade paper',
    'papermaking': 'File:Papermaking mould and deckle',
    'linocut_diy': 'File:Linocut printmaking process',
    'linocut': 'File:Linocut printing tools',
    'canvas_stretch': 'File:Stretched canvas artist'
}
