...
# PowerShell script to crop and save images cleanly to 1200x800
ps_script = """
...
with open("scratch/crop_craft_images.ps1", "w", encoding="utf-8") as f:
    f.write(ps_script)

print("Saved scratch/crop_craft_images.ps1")
