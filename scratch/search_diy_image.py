...
queries = {
    'bookbinding': 'File:Bookbinding tools and materials',
    'bookbinding2': 'File:Handmade book binding',
    'woodcraft': 'File:Woodworking hand tools bench',
    'pottery_diy': 'File:Pottery hand building'
}
